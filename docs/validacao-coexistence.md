...
- Ainda pendentes: callback Meta apontado ao código novo, onboarding pelo celular e mensagens reais. O callback permanece em produção; não iniciar teste real antes de ajustá-lo, pois a versão antiga pode responder automaticamente.
