...
Verificação local em 13/09/2026: lint, TypeScript, 45 testes e build Next.js 16.3.5; `npm audit` também aprovado na verificação anterior (zero vulnerabilidades reportadas). Os testes não comprovam elegibilidade da Meta, entrega real, carga de histórico ou integração completa do preview.
