...
export function ReviewSendPanel({ operationId, recipient, body, ready }: { operationId: string; recipient: string; body?: string; ready: boolean }) {
  const [state, action, pending] = useActionState(sendReviewMessageAction, {} as ReviewSendState);
